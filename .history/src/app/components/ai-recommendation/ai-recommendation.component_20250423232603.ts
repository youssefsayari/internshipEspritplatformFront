...
export class AiRecommendationComponent implements OnInit {
  ...
  bookConsultation() {
    ...
    // Convert the selectedDate (string) to LocalDateTime format (e.g., 'yyyy-MM-ddTHH:mm:ss')
  ...
  formatDateTime(dateString: string): string {
    ...
    return date.toISOString();  // Converts to ISO 8601 format, e.g., "2025-04-23T14:00:00.000Z"
  }
}
