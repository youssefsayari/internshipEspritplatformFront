...
export const ROUTES: RouteInfo[] = [
  /*  { path: '/user-profile', title: 'My Profile',  icon:'users_single-02', class: '' },
    ...
    { path: '/quiz-list', title: 'All Quizzes',  icon:'ui-2_chat-round', class: '' },

    { path: '/add-quiz', title: 'Add Quiz',  icon:'ui-2_chat-round', class: '' },
    { path: '/quiz-list-user', title: 'My Quizzes',  icon:'ui-2_chat-round', class: '' },

   /* { path: '/add-questions', title: 'Add Questions',  icon:'ui-2_chat-round', class: '' }*/
